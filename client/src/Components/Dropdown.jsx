...
export default function Dropdown() {
  ...
  //Event handler for selecting a company
  ...
  return (
    <div className="relative mt-2 mb-10 ">
              ...
              <span className="flex items-center">
                <span className="ml-3 block truncate">
                  {selected ? (
                    ...
                    <span>
                      <i className="bi bi-buildings text-gray-800 mr-2 text-xl"></i>{" "}
                      My companies{" "}
                    </span>
                  )}
                </span>
                    ...
                    className={({ active }) =>
                      classNames(
                        active
                          ...
                          : "text-gray-900 bg-gray-200 transition-colors",
      ...
      {showButton && (
        ...
        >
          See details <i className="bi bi-arrow-right ml-2"></i>
        </button>
      )}
    </div>
  );
